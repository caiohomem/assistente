...
<body>
    <div class=""email-container"">
        ...
        <div class=""footer""><p><strong>Assistente Executivo</strong></p></div>
            ...
            ,
            new EmailTemplate(
                name: "Acordo - Proposta de Aceite",
                templateType: EmailTemplateType.AgreementProposal,
                subject: "Aceite do acordo: {{ AgreementTitle }}",
                htmlBody: @"<!DOCTYPE html>
<html lang=""pt-BR"">
<head>
    <meta charset=""UTF-8"">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #18181b; background-color: #f8fafc; }
        .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; }
        .header { background: linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%); color: #ffffff; padding: 36px 30px; text-align: center; }
        .header h1 { font-size: 26px; font-weight: 700; }
        .content { padding: 36px 30px; background-color: #ffffff; }
        .content h2 { color: #18181b; font-size: 20px; margin-bottom: 16px; font-weight: 600; }
        .content p { color: #52525b; font-size: 16px; margin-bottom: 12px; }
        .details { background-color: #f4f4f5; padding: 16px; border-radius: 6px; margin: 20px 0; }
        .details p { margin-bottom: 8px; }
        .button { display: inline-block; background: linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%); color: #ffffff !important; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600; font-size: 16px; margin: 20px 0; text-align: center; }
        .footer { background-color: #f8fafc; padding: 24px; text-align: center; border-top: 1px solid #e4e4e7; }
...
<body>
    <div class=""email-container"">
        ...
        <div class=""footer"">
            ...
            ,
            new EmailTemplate(
                name: "Acordo - Lembrete de Aceite",
                templateType: EmailTemplateType.AgreementReminder,
                subject: "Lembrete: aceite do acordo {{ AgreementTitle }}",
                htmlBody: @"<!DOCTYPE html>
<html lang=""pt-BR"">
<head>
    <meta charset=""UTF-8"">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #18181b; background-color: #fff7ed; }
        .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; }
        .header { background: linear-gradient(135deg, #f97316 0%, #f59e0b 100%); color: #ffffff; padding: 36px 30px; text-align: center; }
        .header h1 { font-size: 26px; font-weight: 700; }
        .content { padding: 36px 30px; background-color: #ffffff; }
        .content h2 { color: #18181b; font-size: 20px; margin-bottom: 16px; font-weight: 600; }
        .content p { color: #52525b; font-size: 16px; margin-bottom: 12px; }
        .details { background-color: #ffedd5; padding: 16px; border-radius: 6px; margin: 20px 0; }
        .details p { margin-bottom: 8px; }
        .button { display: inline-block; background: linear-gradient(135deg, #f97316 0%, #f59e0b 100%); color: #ffffff !important; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600; font-size: 16px; margin: 20px 0; text-align: center; }
        .footer { background-color: #fff7ed; padding: 24px; text-align: center; border-top: 1px solid #fed7aa; }
        .footer p { color: #7c2d12; font-size: 13px; }
    </style>
</head>
<body>
    <div class=""email-container"">
        ...
        <div class=""footer"">
            ...
            ,
            new EmailTemplate(
                name: "Acordo - Aprovado",
                templateType: EmailTemplateType.AgreementApproved,
                subject: "Acordo aprovado: {{ AgreementTitle }}",
                htmlBody: @"<!DOCTYPE html>
<html lang=""pt-BR"">
<head>
    <meta charset=""UTF-8"">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #18181b; background-color: #ecfdf3; }
        .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; }
        .header { background: linear-gradient(135deg, #16a34a 0%, #22c55e 100%); color: #ffffff; padding: 36px 30px; text-align: center; }
        .header h1 { font-size: 26px; font-weight: 700; }
        .content { padding: 36px 30px; background-color: #ffffff; }
        .content h2 { color: #18181b; font-size: 20px; margin-bottom: 16px; font-weight: 600; }
        .content p { color: #52525b; font-size: 16px; margin-bottom: 12px; }
        .details { background-color: #dcfce7; padding: 16px; border-radius: 6px; margin: 20px 0; }
        .details p { margin-bottom: 8px; }
        .footer { background-color: #ecfdf3; padding: 24px; text-align: center; border-top: 1px solid #bbf7d0; }
        .footer p { color: #166534; font-size: 13px; }
    </style>
</head>
<body>
    <div class=""email-container"">
