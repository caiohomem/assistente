...
namespace AssistenteExecutivo.Infrastructure.Migrations
{
    ...
    [Migration("20251224231910_AddCreditPackages")]
    partial class AddCreditPackages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AssistenteExecutivo.Domain.Entities.CreditTransaction", b =>
                {
                    ...
                    b.Property<string>("IdempotencyKey_Value")
                    ...
                    b.HasIndex("IdempotencyKey_Value")
                        .IsUnique()
            ...
            modelBuilder.Entity("AssistenteExecutivo.Domain.Entities.CreditTransaction", b =>
                {
                    ...
                    b.OwnsOne("AssistenteExecutivo.Domain.ValueObjects.IdempotencyKey", "IdempotencyKey", b1 =>
                        {
                            b1.Property<Guid>("CreditTransactionTransactionId")
                                .HasColumnType("uniqueidentifier");
