...
public class DisputeAgreementCommandHandler : IRequestHandler<DisputeAgreementCommand, Unit>
{
    ...
    public DisputeAgreementCommandHandler(
    ...
    public async Task<Unit> Handle(DisputeAgreementCommand request, CancellationToken cancellationToken)
    {
        ...
        agreement.Dispute(request.Reason, _clock);
