...
public class SendDraftCommandHandler : IRequestHandler<SendDraftCommand>
{
    ...
    public async Task Handle(SendDraftCommand request, CancellationToken cancellationToken)
    {
        ...
        draft.Send(request.OwnerUserId, _clock);
