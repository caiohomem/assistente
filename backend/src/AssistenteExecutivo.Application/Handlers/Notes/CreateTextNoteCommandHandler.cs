...
public class CreateTextNoteCommandHandler : IRequestHandler<CreateTextNoteCommand, Guid>
{
    ...
    public CreateTextNoteCommandHandler(
    ...
    public async Task<Guid> Handle(CreateTextNoteCommand request, CancellationToken cancellationToken)
    {
