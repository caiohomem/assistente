...
public class CompleteMilestoneCommandHandler : IRequestHandler<CompleteMilestoneCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CompleteMilestoneCommand request, CancellationToken cancellationToken)
    {
        ...
        agreement.CompleteMilestone(
            request.MilestoneId,
            request.Notes,
            request.ReleasedPayoutTransactionId,
            _clock);
